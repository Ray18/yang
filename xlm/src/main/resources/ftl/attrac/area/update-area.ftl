    ...
    <form class="layui-form layui-form-pane" style="margin-left: 20px;">
        ...
        <div class="layui-form-item">
            <fieldset class="layui-elem-field layui-field-title" style="margin-top: 10px;">
                <legend style="font-size:16px;">图片修改</legend>
            </fieldset>
            ...
            <div class="layui-input-inline">
                <div id="demo2" style="margin-top: 20px;margin-left: 50px">
                    <img src="${attraccitycase.headImg}" width="100px" height="100px"
        ...
        <div class="layui-form-item">
            <fieldset class="layui-elem-field layui-field-title" style="margin-top: 10px;">
                <legend style="font-size:16px;">标题修改</legend>
            </fieldset>
            <label for="name" class="layui-form-label">
                <span class="x-red">*</span>标题
            </label>
            <div class="layui-input-inline">
                <input type="text" id="title" name="title" value="${attraccitycase.title}" lay-verify="title"
        ...
        <div class="layui-form-item">
            ...
            <textarea id="demo" name="caseDetails" lay-verify="caseDetails">
                    ${attraccitycase.caseDetails}
                </textarea>
            <input type="hidden" id="headImg" value="${attraccitycase.headImg}" name="headImg"/>
            <input value="${attraccitycase.id}" type="hidden" name="id">
        </div>
...
<script>
    ...
    layui.use(['form', 'layer', 'upload', 'layedit'], function () {
        ...
        form.on('submit(add)', function (data) {
            layerAjax('updateCityCase', data.field, 'citycaseList');
            return false;
        });
        form.render();
    });
