    ...
    layui.use('table', function () {
        ...
        table.render({
            ...
            , cols: [[
                ...
                , {field: 'headImg', title: '头图', width: '20%', sort: true}
                , {field: 'caseDetails', title: '图文详情', width: '20%', sort: true}
        ...
        var $ = layui.$, active = {
            ...
            add: function () {
                add('添加案例', '/qj/citycase/showAddCityCase', 700, 450);
            }
        };
