    ...
    <form class="layui-form layui-form-pane" style="margin-left: 20px;">
        <div style="width:100%;overflow: auto;">
            ...
            <div class="layui-input-inline">
                ...
                <input type="hidden" id="coverImg" value="${pro.coverImg}" name="coverImg" lay-verify="coverImg"/>
                <button type="button" class="layui-btn" id="upload">
                    <i class="layui-icon">&#xe67c;</i>上传图片
                </button>
            </div>
            <div class="layui-form-item" id="imgs">
                <img src="${pro.coverImg}" width="100px" height="100px" >
            </div>
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="text" id="productName" value="${pro.productName}" name="productName" lay-verify="productName"
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="text" id="price" value="${pro.price}" name="price" lay-verify="price"
                           autocomplete="off" class="layui-input">
                </div>
            </div>
            <div class="layui-form-item">
                ...
                <textarea id="demo"  name="productDetails" lay-verify="productDetails" lay-verify="productDetails">
                    ${pro.productDetails}
                </textarea>
            </div>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="radio" name="upState" value="1" title="上架" <#if pro.upState==true> checked='checked'</#if>>
                    <input type="radio" name="upState" value="0" title="下架" <#if pro.upState==false> checked='checked'</#if>>
                </div>
            </div>
        </div>
