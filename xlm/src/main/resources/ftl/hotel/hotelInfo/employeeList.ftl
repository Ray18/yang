...
<div class="lenos-search">
    ...
    <div class="select">
        ...
        工号：
        <span class="layui-inline">
                 <input class="layui-input" height="20px" id="jobNumber" autocomplete="off">
        </span>
...
<script type="text/html" id="bar">
    {{# if(d.up){ }}
    <a class="layui-btn layui-btn-xs  layui-btn-normal" lay-event="down">禁用</a>
    {{# } }}
    {{# if(!d.up){ }}
    <a class="layui-btn layui-btn-xs  layui-btn-normal" lay-event="up">启用</a>
    {{# } }}
</script>
<script>
    ...
    layui.use('table', function () {
        ...
        table.render({
            ...
            , cols: [[
                ...
                , {field: 'employeeName', title: '名片称呼', sort: true}
                , {field: 'wechat', title: '微信号', sort: true}

                , {field: 'up', title: '账号状态', sort: true}
                , {
                    field: 'wechatImg',
                    title: '微信二维码',
                    width: 110,
                    ...
                    sort: true,
                    templet: function (d) {
                        return '<div><img src="' + d.wechatImg + '"></div>'
                    }
                }
                , {
                    field: 'proofOne',
