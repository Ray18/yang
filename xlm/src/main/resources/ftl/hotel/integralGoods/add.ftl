    ...
    <form class="layui-form layui-form-pane" style="margin-left: 20px;">
        <div style="width:100%;height:400px;overflow: auto;">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="text" id="integral" name="integral" lay-verify="integral"
                           autocomplete="off" class="layui-input">
                </div>
            </div>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="radio" name="newProduct" value="true" title="是" checked="">
                    <input type="radio" name="newProduct" value="false" title="否">
                </div>
            </div>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="radio" name="upState" value="true" title="上架" checked="">
                    <input type="radio" name="upState" value="false" title="下架">
                </div>
            </div>
