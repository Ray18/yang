    ...
    <script>
        ...
        layui.use('table', function () {
            ...
            table.render({
                ...
                , cols: [[
                    ...
                    , {
                        ...
                        sort: true,
                        templet: function (d) {
                            return '<div><img src="' + d.specImg + '"></div>'
                        }
                    }
                    , {field: 'name', title: '规格', sort: true}
                    , {field: 'price', title: '积分', sort: true}

                    , {field: 'inventory', title: '库存(个)', sort: true}
            ...
            var $ = layui.$, active = {
                ...
                add: function () {
                    add('添加产品', '/m/integralGoodsSpec/toAdd?goodsId='+'${id}', 650, 650);
                },
                update: function () {
                    ...
                    update('编辑', '/m/integralGoodsSpec/toUpdate?id=' + data[0].id, 700, 700);
                }
            };
            ...
            table.on('tool(user)', function (obj) {
                ...
                if (obj.event === 'detail') {
                    ...
                    update('编辑', '/m/integralGoodsSpec/toUpdate?id=' + data.id, 700, 700);
                }
