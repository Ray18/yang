    ...
    <form class="layui-form layui-form-pane" style="margin-left: 20px;">
        <div style="width:100%;height:400px;overflow: auto;">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="text" id="inventory" value="${model.inventory}" name="inventory" lay-verify="inventory"
                           autocomplete="off" class="layui-input">
                </div>
            </div>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="text" id="price" value="${model.price}" name="price" lay-verify="price"
                           autocomplete="off" class="layui-input">
                </div>
            </div>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="hidden" id="specImg" value="${model.specImg}" name="specImg" lay-verify="specImg"/>
            ...
            <div class="layui-form-item" id="coverImgDiv">
                <img src="${model.specImg}" width="100px" height="100px">
            </div>
