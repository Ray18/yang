...
<div class="lenos-search">
    <div class="len-form-item">
        <button type="button" class="layui-btn layui-btn-normal layui-btn layui-btn-sm" data-type="select">刷新</button>
    </div>
</div>
...
<script type="text/html" id="bar">
    ...
    <@shiro.hasPermission name="sys:updateParameter">
        <a class="layui-btn layui-btn-xs  layui-btn-normal" lay-event="edit">编辑</a>
    </@shiro.hasPermission>
<#--    <@shiro.hasPermission name="sys:parameterDel">
    ...
    layui.use('table', function () {
        ...
        table.render({
            ...
            , cols: [[
                ...
                , {field: 'parValue', title: '参数值', width: '20%', sort: true}
                , {field: 'remark', title: '参数描述', width: '20%', sort: true}
                , {field: 'code', title: '参数code', width: '20%', sort: true}
                , {field: 'details', title: '图文详情', width: '20%', sort: true}
        ...
        var $ = layui.$, active = {
            ...
            add: function () {
                add('添加产品', '/m/parameter/toAddParameter', 650, 650);
            },
            update: function () {
                ...
                update('编辑', '/m/parameter/toUpdateParameter?id=' + data[0].id, 700, 450);
            }
        };
        ...
        table.on('tool(user)', function (obj) {
            ...
            if (obj.event === 'detail') {
                ...
                update('编辑', '/m/parameter/toUpdateParameter?id=' + data.id, 700, 650);
            }
        });
