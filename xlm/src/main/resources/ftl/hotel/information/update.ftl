    ...
    <form class="layui-form layui-form-pane" style="margin-left: 20px;">
        <div style="width:100%;height:400px;overflow: auto;">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="hidden" id="headImg" value="${model.headImg}" name="headImg" lay-verify="headImg"/>
            ...
            <div class="layui-form-item" id="coverImgDiv">
                <img src="${model.headImg}" width="100px" height="100px">
            </div>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="hidden" id="fileUrl" value="${model.fileUrl}" name="fileUrl" lay-verify="fileUrl"/>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="radio" name="type" <#if model.type==1> checked='checked'</#if>
                           value="1" title="工具" checked="">
                    <input type="radio" name="type" <#if model.type==2> checked='checked'</#if>
                           value="2" title="内容">
                </div>
            </div>
