    ...
    <form class="layui-form layui-form-pane" style="margin-left: 20px;">
        <div style="width:100%;height:400px;overflow: auto;">
            ...
            <div class="layui-input-inline">
                ...
                <input type="text" id="projectName" value="${model.projectName}" name="projectName"
                       lay-verify="caseName"
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="text" id="caseName" value="${model.caseName}" name="caseName" lay-verify="caseName"
                           autocomplete="off" class="layui-input">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="text" id="projectAddress" value="${model.projectAddress}" name="projectAddress"
                           lay-verify="caseInfo"
                           autocomplete="off" class="layui-input">
                </div>
            </div>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="text" id="province" name="province" lay-verify="province" value="${model.province}"
                           autocomplete="off" class="layui-input">
                </div>
            </div>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="text" id="city" name="city" lay-verify="city" value="${model.city}"
                           autocomplete="off" class="layui-input">
                </div>
            </div>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="text" id="district" name="district" lay-verify="district" value="${model.district}"
                           autocomplete="off" class="layui-input">
                </div>
            </div>
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="text" id="lng" name="lng" lay-verify="lng" value="${model.lng}"
                           autocomplete="off" class="layui-input">
                </div>
            </div>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="text" id="lat" name="lat" lay-verify="lat" value="${model.lat}"
                           autocomplete="off" class="layui-input">
                </div>
            </div>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="radio" name="hotelType" <#if model.hotelType==1> checked='checked'</#if> value="1"
                           title="酒店">
                    <input type="radio" name="hotelType" <#if model.hotelType==2> checked='checked' </#if>value="2"
                           title="地产">
                    <input type="radio" name="hotelType"<#if model.hotelType==3> checked='checked'</#if> value="3"
                           title="其他">
                </div>
            </div>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="text" id="caseClass" name="caseClass" lay-verify="caseClass" value="${model.caseClass}"
                           autocomplete="off" class="layui-input">
                </div>
            </div>
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="text" id="caseSku" name="caseSku" lay-verify="caseSku" value="${model.caseSku}"
                           autocomplete="off" class="layui-input">
                </div>
            </div>
