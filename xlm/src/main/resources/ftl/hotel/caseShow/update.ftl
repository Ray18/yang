    ...
    <form class="layui-form layui-form-pane" style="margin-left: 20px;">
        <div style="width:100%;height:400px;overflow: auto;">
            ...
            <div class="layui-input-inline">
                ...
                <input type="text" id="caseName" name="caseName" lay-verify="caseName" value="${model.caseName}"
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="text" id="caseInfo" name="caseInfo" lay-verify="caseInfo" value="${model.caseInfo}"
                           autocomplete="off" class="layui-input">
                </div>
            </div>
            <div class="layui-form-item">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <select name="type">
                        <#list type as value>
                            <option value="${value.id}" <#if value.id==model.type > selected</#if> > ${value.name!''}</option>
                        </#list>
                    </select>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="radio" name="up" value="true" title="上架" <#if model.up==true> checked='checked'</#if>>
                    <input type="radio" name="up" value="false" title="下架" <#if model.up==false> checked='checked'</#if>>
                </div>
            </div>
        </div>
