...
<script type="text/html" id="bar">
    ...
    {{# } }}
    <@shiro.hasPermission name="hotel:updateCaseShow">
        <a class="layui-btn layui-btn-xs  layui-btn-normal" lay-event="edit">编辑</a>
    </@shiro.hasPermission>
    <@shiro.hasPermission name="hotel:caseShowDel">
    ...
    layui.use('table', function () {
        ...
        table.render({
            ...
            , cols: [[
                ...
                , {field: 'caseName', title: '产品名称', sort: true}
                , {field: 'caseInfo', title: '参数描述',  sort: true}
        ...
        var $ = layui.$, active = {
            ...
            add: function () {
                add('添加产品', '/m/hotelCaseShow/toAddCaseShow', 650, 650);
            },
            update: function () {
                ...
                update('编辑', '/m/hotelCaseShow/toUpdateCaseShow?id=' + data[0].id, 700, 450);
            }
        };
        ...
        table.on('tool(user)', function (obj) {
            ...
            if (obj.event === 'detail') {
                ...
                update('编辑', '/m/hotelCaseShow/toUpdateCaseShow?id=' + data.id, 700, 650);
            }
            //上架操作
            if(obj.event === 'up'){
