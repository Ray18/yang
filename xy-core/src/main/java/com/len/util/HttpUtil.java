...
/*        Map<String, String> map = new HashMap<>();
        ...
        params.put("LOGIN_ID","BSSA");
        params.put("SYS_CODE","Website");
        params.put("TPL_ID","23");
        params.put("SJHM","17606522338");
        params.put("CODE","小杨:2222");
        HttpUtil httpUtil = HttpUtil.init();
        httpUtil.setParam("param",params.toJSONString());
        String URL ="https://10.7.200.101:4008/api/message/sms2/send";
